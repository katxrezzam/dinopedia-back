...
import { isString, numberValidation, stringValidation } from "./_validation"
...
export const toNewDinosaur = (object: any): CreateDinasaur => {
  const newDinosaur: CreateDinasaur = {
    ...
    article_id: numberValidation(object.article_id)
  }
  return newDinosaur
}
export const toNewUpdateDinosaur = (object: any): UpdateDinosaur => {
  ...
  if(dino.article_id) dino.article_id = numberValidation(dino.article_id)
